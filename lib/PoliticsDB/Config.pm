package PoliticsDB::Config;
use MooseX::Singleton;
our $VERSION = '0.01';

use YAML::XS 0.39;

my $CONFIG = $ENV{PoliticsDB_CONFIG} || "/etc/politicsdb/config.yml";
...
=head1 SYNOPSIS
  ...
  my $value = PoliticsDB::Config->get('parameter');

=head1 DESCRIPTION

This module provides easy access to configuration parameters. It automatically
loads configuration from /etc/politicsdb/config.yml and allows to access it via I<get>
method. You can change location of configuration file by setting PoliticsDB_CONFIG
